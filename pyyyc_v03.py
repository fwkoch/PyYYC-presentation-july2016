...
class BasePresentation(object):
    ...
    This class contains info about basic presentations.
...
class PyYYCPresentation(BasePresentation):
...
class YYCjsPresentation(BasePresentation):
    ...
    def strains_eyes(self):
        """Determines if the slides will cause eye strain based on their
        color. "Nothing strains our eyes!" - JavaScripters
        """
        return False


class FreeSpiritPresentation(BasePresentation):
    """ class FreeSpiritPresentation

    This class contains info about basic presentations given by
    people who really just don't care.

    No topic, no time-limit, no slides. Just a presenter and their
    favorite color.
    """
